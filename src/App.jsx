...
function App() {
  ...
  const [todos, setTodos] = useState(() => {
    try {
      ...
      console.log(`Hiba a localstroage beolvasásakor: ${error}`);
      return []
    }
  })
  ...
  // mentés localStorage-be, amikor változik a lista (annyiszor fut le a mellékhatás, ahányszor a todos belső állapota változik)
  useEffect(() => {
    try {
